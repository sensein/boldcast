...
def format_report(est: MemoryEstimate, cfg: ModelConfig) -> str:
    ...
    lines = [
        ...
        f"Sequence: {cfg.seq_len} TRs × {cfg.n_spatial_tokens} spatial tokens × dim {cfg.hidden_dim}",
        ...
        f"",
        f"--- Activation Memory (per sequence) ---",
...
def main():
    ...
    if args.sweep:
        configs = [
            ...
            ("roi_baseline", ModelConfig(n_spatial_tokens=400, hidden_dim=128, n_temporal_layers=6)),
        ]
        results = {}
